...
/**
 * Adds definition to swaggerObject
 * @function
 * @param {object} swaggerObject - Swagger object which will be written to
 * @param {object} pathObject - JSDoc comments tagged with '@swagger'
 * @param {string} propertyName - Property Name for Swagger Object
 */
function addDefinition(swaggerObject, pathObject, propertyName) {
...
/**
 * Adds security definition to swaggerObject
 * @function
 * @param {object} swaggerObject - Swagger object which will be written to
 * @param {object} pathObject - JSDoc comments tagged with '@swagger'
 * @param {string} propertyName - Property Name for Swagger Object
 */
function addSecurityDefinition(swaggerObject, pathObject, propertyName) {
  swaggerObject.securityDefinitions = objectMerge (
...
/**
 * Adds path to swaggerObject
 * @function
 * @param {object} swaggerObject - Swagger object which will be written to
 * @param {object} pathObject - JSDoc comments tagged with '@swagger'
 * @param {string} propertyName - Property Name for Swagger Object
 */
function addPath(swaggerObject, pathObject, propertyName) {
 ...
 */
function parseDataForSwaggerObject(swaggerObject, swaggerJsDocComments) {
  for (var i = 0; i < swaggerJsDocComments.length; i = i + 1) {
    ...
    for (var j = 0; j < propertyNames.length; j = j + 1) {
      ...
      switch (propertyName) {
        case 'definition': {
          addDefinition(swaggerObject, pathObject, propertyName)
          break;
        }
        ...
        default: {
          addPath(swaggerObject, pathObject, propertyName)
        }
      }
    }
  }
...
module.exports = function(options) {
  ...
  for (var i = 0; i < options.apis.length; i = i + 1) {
    ...
    parseDataForSwaggerObject(swaggerObject, swaggerJsDocComments);
  }
